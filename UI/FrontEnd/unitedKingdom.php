...
<html lang="en">
  ...
  <body>
    ...
    <header>
      ...
      <h1 style="text-align : center; margin : 50px 0px">United Kingdom(Starts from 70000BDT/ Person)</h1>
      ...
      <div class="container" style="padding-bottom: 20px">
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/uk1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="images/uk1.1.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <h5 class="card-title" style="padding-top: 20px"><b>United Kingdom</b></h5>
        <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut eum similique repellat a laborum, rerum voluptates ipsam eos quo tempore iusto dolore modi dolorum in pariatur. Incidunt repellendus praesentium quae!</p>
        <p class="card-text"><b>Starts from: </b> 70000BDT/ Person</p>
        <a href="booktrip.php" class="btn btn-success btn">Book UK Trip Now</a>
