  ...
  <body>
    ...
    <header>
      ...
      <div class="container" style="padding-bottom: 20px">
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="{{asset('FrontEnd/images/us.png')}}" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="{{asset('FrontEnd/images/us1.jpg')}}" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <a href="{{route('booktrip')}}" class="btn btn-success btn">Book US Trip Now</a>
